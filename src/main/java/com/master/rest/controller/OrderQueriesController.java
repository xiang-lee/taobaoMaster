...
public class OrderQueriesController {
	...
	public ResponseEntity<?> addBuying(Principal principal,
	...
	public ResponseEntity<?> addSelling(Principal principal,
			@PathVariable long id) {
	 ...
	 * Five types of Order:
	 * 
	 * Buying: 1. stockpile (囤货) isStockpile=true Buying: 2. Addition (附加)
	 * isStockpile=false
	 * 
	 * 
	 * Selling: 3. Sold(卖出) isSoldToFriend=false && isBrush=false Selling: 4.
	 * Sold to friend(卖给朋友) isSoldToFriend=true Selling: 5. Brush (刷单)
	 * isBrush=true
	 * 
	 */
